...
profits = []
# 5 days of the week
#                 Friday,             Mon,                   Tuesday,              Wednesay,               Thursaday
timeToExp = [ 6*60*24 + timetoEOD,  3*60*24 + timetoEOD,  2*60*24 + timetoEOD, 1*60*24 + timetoEOD,  7*60*24 + timetoEOD ]
...
print ( " %d Simulations " % numSimulations )
